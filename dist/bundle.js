...
(function (App) {
    class ProjectList extends App.Component {
        ...
        dropHandler(event) {
            ...
            App.projectState.moveProject(prjId, this.type === "active" ? App.ProjectStatus.Active : App.ProjectStatus.completed);
        }
        ...
        configure() {
            ...
            App.projectState.addListener((projects) => {
                const relevantProjects = projects.filter((prj) => {
                    ...
                    return prj.status === App.ProjectStatus.completed;
                });
