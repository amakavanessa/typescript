...
define("components/project-list", ["require", "exports", "components/base-component", "models/project", "decorators/autobind", "state/project-state", "components/project-item"], function (require, exports, base_component_3, project_2, autobind_3, project_state_2, project_item_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class ProjectList extends base_component_3.Component {
        ...
        dropHandler(event) {
            ...
            project_state_2.projectState.moveProject(prjId, this.type === "active" ? project_2.ProjectStatus.Active : project_2.ProjectStatus.completed);
        }
        ...
        configure() {
            ...
            project_state_2.projectState.addListener((projects) => {
                const relevantProjects = projects.filter((prj) => {
                    ...
                    return prj.status === project_2.ProjectStatus.completed;
                });
...
define("app", ["require", "exports", "components/project-input", "components/project-list"], function (require, exports, project_input_1, project_list_1) {
    ...
    new project_list_1.ProjectList("completed");
});
